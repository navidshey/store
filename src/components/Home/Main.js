...
const Main = () => {
  const tutorialsList = [{ imgLink: '../../images/popular/1.jpg', duration: '3:15h', title: 'How to become an UX Designer', shortDesc: '12 LESSONS', desc: 'At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est.', link: '/tutorial' },
  ...
  const prosList = [{ avatar: '../../images/avatars/1.png', profileImg: '../../images/avatars/profile.png', shortDesc: '8 VIDEOS', title: 'Kevin Mcfield' },
    { avatar: '../../images/avatars/2.png', profileImg: '../../images/avatars/profile.png', shortDesc: '8 VIDEOS', title: 'Kevin Mcfield' },
    { avatar: '../../images/avatars/3.png', profileImg: '../../images/avatars/profile.png', shortDesc: '8 VIDEOS', title: 'Kevin Mcfield' },
    { avatar: '../../images/avatars/4.png', profileImg: '../../images/avatars/profile.png', shortDesc: '8 VIDEOS', title: 'Kevin Mcfield' },
    { avatar: '../../images/avatars/5.png', profileImg: '../../images/avatars/profile.png', shortDesc: '8 VIDEOS', title: 'Kevin Mcfield' },
    { avatar: '../../images/avatars/6.png', profileImg: '../../images/avatars/profile.png', shortDesc: '8 VIDEOS', title: 'Kevin Mcfield' }]
  return (
      ...
      <div className="container index-3-categories text-center">
        <div className="row">
          <div className="col-sm-10 col-sm-offset-1">
            ...
            <p>
              At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, coniam voluptua.
            </p>
          </div>
        </div>
