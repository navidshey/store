...
class Detail extends React.Component {
  ...
  componentDidMount () {
    ...
    TutorialApi.getById(this.props.match.params.id).then(item =>
      this.setState({
          ...
          <div className="row">
            <div className="col-md-9">
              <img
                ...
                alt="Course"
                className="resp-img course-preview"
              />
              ...
              <p className="class-details">
                <span className="lessons">
                  ...
                  {this.state.lessonNumber} LESSONS
                </span>
                ...
                <span className="views">
                  ...
                  {this.state.viewed} VIEWS
                </span>
              </p>

              <h4>COURSE DETAILS</h4>
              <p className="abs">{this.state.courseDetails}</p>
            ...
            <div className="col-md-3">
              <div className="order text-center">
                ...
                <p>SINGLE PRICE</p>
                <a href="course-single.html#" className="blueplay">
                  BUY THIS COURSE
                </a>
                <p className="order-or">
                  <span>OR</span>
                </p>
                <p>SIGN UP FOR</p>
                <a href="course-single.html#" className="greybutton">
                  PREMIUM MEMBERSHIP
                </a>
              </div>
              <div className="pros">
              ...
              <div className="ratings">
                ...
                <div className="rating">
                  <a href="course-single.html#" className="on">
                    <i className="zmdi zmdi-star zmdi-hc-2x"></i>
                  </a>
                  <a href="course-single.html#" className="on">
                    <i className="zmdi zmdi-star zmdi-hc-2x"></i>
                  </a>
                ...
                <p>
                  (37 votes, average: <strong>4.8</strong> out of 5)
                </p>
              </div>
              <div className="popular-courses index-3-categories">
                ...
                <div className="courses-side-slick">
                  <div className="category-with-bg text-center cat1">
                    ...
                    <a href="course-single.html#" className="goto">
              ...
              <div className="categories">
                ...
                <ul>
                  <li>
                    <a href="course-single.html#">Business (18)</a>
                  </li>
                  <li>
                    <a href="course-single.html#">CMS (14)</a>
                  </li>
                  <li>
                    <a href="course-single.html#">Design (17)</a>
                  </li>
                  <li>
                    <a href="course-single.html#">Development (23)</a>
                  </li>
                  <li>
                    <a href="course-single.html#">Humanities (17)</a>
                  </li>
                  <li>
                    <a href="course-single.html#">Mecidine (8)</a>
                  </li>
                  <li>
                    <a href="course-single.html#">Music (47)</a>
                  </li>
                  <li>
                    <a href="course-single.html#">Photography (68)</a>
                  </li>
                  <li>
                    <a href="course-single.html#">Photoshop (87)</a>
                  </li>
                  <li>
                    <a href="course-single.html#">IT &amp; Software (41)</a>
                  </li>
                  <li>
                    <a href="course-single.html#">Lifestyle (54)</a>
                  </li>
                  <li>
                    <a href="course-single.html#">Languages (83)</a>
                  </li>
                  <li>
                    <a href="course-single.html#">SEO (39)</a>
                  </li>
                  <li>
                    <a href="course-single.html#">Marketing (44)</a>
                  </li>
                  <li>
                    <a href="course-single.html#">Video Production (33)</a>
                  </li>
                </ul>
              </div>
            </div>
